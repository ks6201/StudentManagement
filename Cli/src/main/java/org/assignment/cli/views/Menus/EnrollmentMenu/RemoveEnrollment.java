...
public class RemoveEnrollment implements IMenu {
    @Override
    public MenuNode getMenu() {
        return new TerminalMenuNode("Remove Enrollment", (console, scanner) -> {
            try {
                ...
                enrollmentService.removeEnrollment(enrollment.getEnrollmentId());

                console.println("Enrollment removed.");
